...
export class LocationsService {
  ...
  async getSubNeighborhoods(neighborhoodId: number) {
    return this.locationRepository.find({ where: { type: 'sub_neighborhood', parent_id: neighborhoodId }, order: { name: 'ASC' } });
  }
