...
### Properties
- `POST /properties` - Create property (requires JWT)
- `GET /properties` - List properties with filters
- `GET /properties/:id` - Get property details
- `GET /properties/owner/:userId` - Get user's properties
- `PATCH /properties/:id` - Update property (requires JWT)
- `DELETE /properties/:id` - Delete property (requires JWT)

### Query Parameters
- `limit` - Number of results (default: 10)
- `offset` - Pagination offset (default: 0)

### Filters (Properties only)
- `city` - Filter by city
- `propertyType` - Filter by type (apartment, house, land, commercial)
